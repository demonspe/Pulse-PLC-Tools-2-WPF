...
namespace Pulse_PLC_Tools_2._0
{
    public partial class MainWindow : Window
    {
        ...
        {
            CMD_Buffer.Add_CMD(link, protocol, (int)PulsePLCv2Commands.Check_Pass, null, 0);
            CMD_Buffer.Add_CMD(link, protocol, (int)PulsePLCv2Commands.Clear_Errors, null, 0);
            CMD_Buffer.Add_CMD(link, protocol, (int)PulsePLCv2Commands.Close_Session, null, 0);
        }
        ...
        private void button_Pass_Write_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                CMD_Buffer.Add_CMD(link, protocol, (int)PulsePLCv2Commands.Check_Pass, null, 0);
                CMD_Buffer.Add_CMD(link, protocol, (int)PulsePLCv2Commands.Pass_Write, new bool[] { (bool)checkBox_Write_Pass.IsChecked, (bool)checkBox_Read_Pass.IsChecked }, 0);
                CMD_Buffer.Add_CMD(link, protocol, (int)PulsePLCv2Commands.Close_Session, null, 0);
            }
        }
