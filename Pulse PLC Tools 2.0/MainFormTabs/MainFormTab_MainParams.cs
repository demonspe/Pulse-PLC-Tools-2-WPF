...
namespace Pulse_PLC_Tools_2._0
{
    public partial class MainWindow : Window
    {
        ...
        {
            CMD_Buffer.Add_CMD(Commands.Check_Pass, link, null, 0);
            CMD_Buffer.Add_CMD(Commands.Clear_Errors, link, null, 0);
            CMD_Buffer.Add_CMD(Commands.Close_Session, link, null, 0);
        }
        ...
        private void button_Pass_Write_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                CMD_Buffer.Add_CMD(Commands.Check_Pass, link, null, 0);
                CMD_Buffer.Add_CMD(Commands.Pass_Write, link, new bool[] { (bool)checkBox_Write_Pass.IsChecked, (bool)checkBox_Read_Pass.IsChecked }, 0);
                CMD_Buffer.Add_CMD(Commands.Close_Session, link, null, 0);
            }
        }
