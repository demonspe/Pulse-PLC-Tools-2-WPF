...
namespace Pulse_PLC_Tools_2._0
{
    public partial class MainWindow : Window
    {
        ...
        private void button_E_Data_Read_Enable(object sender, RoutedEventArgs e)
        {
            PLC_Table_Refresh();
            CMD_Buffer.Add_CMD(Command_type.Check_Pass, link, null, 0);
            CMD_Buffer.Add_CMD(Command_type.Read_E_Data, link, new byte[] { 0 }, 0);
        }
        ...
        public void E_Data_Send_Data_Request(byte[] selected_items)
        {
            ...
            {
                CMD_Buffer.Add_CMD(Command_type.Read_E_Current, link, selected_items[i + 1], 0);
                CMD_Buffer.Add_CMD(Command_type.Read_E_Start_Day, link, selected_items[i + 1], 0);
            }
        }
